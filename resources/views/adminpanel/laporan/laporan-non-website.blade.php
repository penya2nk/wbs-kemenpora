...
@section('bread-list')
    <li><strong>Laporan Non Member</strong></li>
@endsection
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="col-sm-12" style="padding-right: 40px;padding-left: 40px;">
                                    ...
                                    @include('adminpanel.laporan.laporan-range-filter',['months'=>$global_service->getMonth(),'years'=>$global_service->getYear(),'laporan'=>'non'])
                                    ...
                                    <div class="row">                        
                                        ...
                                        <div class="col-sm-12">
                                           ...
                                           <table class="table table-striped display nowrap table-bordered table-hover dataTable dtr-inline" id="data-laporan" width="100%">
                                                <thead>
                                                <tr>
                                                    <th>created</th>   
                                                    <th>filter_date</th>                           
                                            ...
                                            @include('adminpanel.laporan.laporan-rekap-alt',['months'=>$global_service->getMonth(),'years'=>$global_service->getYear(),'laporan'=>'web'])
...
<script type="text/javascript">
    ...
    function tampilData(){
        ...
        //alert(parseDateValue('14/11/2017'));
    ...
    function resetTampilData(){
        ...
        document.getElementById("dateStartField").value = "{{ $global_service->nonGetFirst() }}";
        document.getElementById("dateEndField").value = "{{ $global_service->nonGetLast() }}";
