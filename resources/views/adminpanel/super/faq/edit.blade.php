            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><span class="text-navy">Form Edit FAQ</span></h5>
                                ...
                                <div class="row text-center">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p>Silahkan ubah data faq pada form dibawah ini.
                                    ...
                                    <div class="col-sm-8 col-sm-12">
                                        ...
                                        {!! Form::model($recFaqByID,['method'=>'PATCH', 'action'=>['Admin\Super\Faq\FaqController@update','id'=>$recFaqByID->id]]) !!}
													        ...
													        <div class="form-group ">
													            <div class="input-group">
													                ...
													                <select name="noUrut" class="form-control" required="">
													                	...
													                	@for ($i = 1; $i <= 50; $i++)
													                		<option value="{{$i}}" {{ ($recFaqByID->noUrut==$i)?'selected':'' }}>{{$i}}</option>
													                	@endfor
													                </select>
													            </div>
													        </div>
