                                    ...
                                    <div class="row text-center">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <p>Silahkan ubah data user dibawah.
                                        ...
                                        <div class="col-sm-8 col-sm-12">
                                            ...
                                            {!! Form::model($user,['method'=>'PATCH', 'action'=> ['Admin\Super\User\DataController@update', 'id'=>$user->id]]) !!}

                                                @include('adminpanel.super.user.field',['buttonText'=>'Simpan Perubahan','mode'=>'edit'])
