...
@section('bread-list')    
    ...
    <li><strong>Tambah Kategori</strong></li>
@endsection
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><span class="text-navy">Form Tambah Kategori</span></h5>
                                ...
                                <div class="row text-center">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p>Silahkan tambah data kategori pada form dibawah ini.
                                    ...
                                    <div class="col-sm-8 col-sm-12">
                                        ...
                                        {!! Form::open(['method'=>'POST', 'action'=>'Admin\Super\Kategori\KategoriLaporanController@store']) !!}
