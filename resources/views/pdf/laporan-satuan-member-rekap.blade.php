...
<table width="100%">
	<tr valign="top">
		<td width="30%">Nama</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->fullname }}</td>
	</tr>
	<tr valign="top">
		<td width="30%">Alamat</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->address }}</td>
	</tr>
	<tr valign="top">
		<td width="30%">No. Telepon</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->phoneNumber }}</td>
	</tr>
	<tr valign="top">
		<td width="30%">No. Handphone</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->handphoneNumber }}</td>
	</tr>
	<tr valign="top">
		<td width="30%">Email</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->email }}</td>
	</tr>
	<tr valign="top">
		<td width="30%">No. KTP</td>
		<td width="5%">:</td>
		<td>{{ $global_service->getUserLaporan($laporan->userId)->identityNumber }}</td>
	</tr>
</table>
...
<table width="100%">
	<tr valign="top">
		<td width="30%">Informasi Pelapor</td>
		<td width="5%">:</td>
		<td>Dirahasiakan</td>
	</tr>
</table>
